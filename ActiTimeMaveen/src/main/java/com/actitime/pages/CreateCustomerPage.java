...
{
	@FindBy(xpath="//spam[.='ASSIGNED USERS (3)']") private WebElement assignedusers;
	@FindBy(xpath="//spam[.='MANAGERS (3)']") private WebElement managers;
	...
	public void createCustomerPage(WebDriver driver)
	{
